...
import com.kaiqin.common.vo.ViewOrderDetail;
...
public interface OrderDao {
	...
	//根据订单号找uid
	@Select("select uid from t_order where id=#{oid}")
	@ResultType(Integer.class)
	public int findUidByOid(@Param("oid")String oid);
}
